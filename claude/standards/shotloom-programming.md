...
**When this doc is authoritative:** any time you edit code under !`python3 -c "import json,os; d=json.load(open(os.path.expanduser('~/.claude/private/caol-config/repo-paths.json'))); print(d['shotloom'])"`. Re-read at session start — guidelines drift.
