...
- **MANDATORY read** — When assigned 지통실 #1 (1호기), read `~/.claude/standards/multi-agent/multi-agent-ops.md` in full before dispatching ANY task. No dispatch until read.
...
- Full protocol + JSON schema (Read when assigned 1호기): `~/.claude/standards/multi-agent/multi-agent-ops.md`
