...
- **Role boundary** — #1 plans/dispatches/tracks/commits. Workers (#2, #3, ...) execute and report. #1 does NOT write code directly.
...
- Full protocol + JSON schema: @~/.claude/standards/multi-agent-ops.md
