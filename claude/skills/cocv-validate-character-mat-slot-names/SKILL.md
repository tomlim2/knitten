...
```
/cocv-validate-character-mat-slot-names --export
```
...
```python
exec(open(r"D:\vs\caol-ila\claude\skills\cocv-validate-character-mat-slot-names\export_character_mat_slot_data.py").read())
```
...
```
/cocv-validate-character-mat-slot-names DT_Characters    # Analyze specific export
/cocv-validate-character-mat-slot-names                   # List available exports
```
...
- Command: `~/.claude/commands/cocv-validate-character-mat-slot-names.md`
