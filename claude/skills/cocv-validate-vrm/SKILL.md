...
```
Usage: /cocv-validate-vrm <file_or_dir> [--strict]

  <file_or_dir>  Path to a .vrm file or directory containing .vrm files
  --strict       Treat warnings as failures

Examples:
  /cocv-validate-vrm model.vrm
  /cocv-validate-vrm ./output/ --strict
```
...
- Script not found → show path and suggest running `/cocv-sync-ta-tools`
