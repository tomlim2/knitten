...
```bash
python3 ~/.claude/skills/image-convert-exr/convert.py <input> [options]
```
...
```bash
# Basic conversion
python3 ~/.claude/skills/image-convert-exr/convert.py ~/Downloads/toon_dark.exr

# Resize to 1024x1024
python3 ~/.claude/skills/image-convert-exr/convert.py ~/Downloads/toon_dark.exr -s 1024

# Output as JPG thumbnail
python3 ~/.claude/skills/image-convert-exr/convert.py ~/Downloads/toon_dark.exr -o thumb.jpg -s 64 -f jpg
```
