...
```
Usage: /cci-slack-send-message <channel_name_or_id> <message>
Example: /cci-slack-send-message cinev-art "오늘 아트 리뷰 3시에 합니다"
Example: /cci-slack-send-message C05CS9N5E69 "테스트 메시지"
```
