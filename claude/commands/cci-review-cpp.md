...
2. Apply all checklist items from the cci-review-code agent
...
```
/cci-review-cpp Plugins/VRM4U/Source/VRM4ULoader/Private/CinevGlbSanitizer.cpp
```

**Review changes in last 3 commits:**
```
/cci-review-cpp HEAD~3
```

**Review staged changes only:**
```
/cci-review-cpp staged
```
