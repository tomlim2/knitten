...
Usage: `/cocv-download-vrm-z <characterId> [characterId2 ...]`
...
```bash
python ~/.claude/skills/cocv-download-vrm-z/download.py $ARGUMENTS
```
...
/cocv-download-vrm-z anju_v3 bleue_v1 rouge_v2
/cocv-download-vrm-z anju_v3 bleue_v1 -o ./vrm_output
```
