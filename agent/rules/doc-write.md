---
load: triggered
trigger: writing any doc to vault, staging, private/, or local runtime paths
---
...
- **`.agent-local/**`** — allowed only for transient runtime state. Durable records MUST NOT live there.
