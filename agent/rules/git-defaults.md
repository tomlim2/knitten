...
- **Local report inbox exception** — Do not create a branch or worktree solely to leave a report-only handoff. Write transient cross-session reports under gitignored `.agent-local/reports/`. If the report becomes durable policy, a spec, a decision, or an accepted finding, move it to the tracked owner path and use the normal worktree flow.
