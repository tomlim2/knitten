...
This document defines **what to check** from a UX perspective in Python GUI code. Use `agent/document-templates/review/code-review.md` for how to format findings.
