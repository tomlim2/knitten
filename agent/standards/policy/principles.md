...
**rule** — Short enforceable directive. Body cap: 40 lines (auto) or 120 lines (triggered). Lives in `agent/rules/`.
...
- `artifact-pack-registry-merge`
- `pluginization-inventory-report`
- `pluginization-manifest-dry-run`
- `pluginization-pilot-verification`
- `example-skill-pack`
- `skill-root-shape`
- `skill-mechanics`
