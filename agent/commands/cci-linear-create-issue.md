...
Example:
  /cci-linear-create-issue 파편화된 Cinev 메시 설정 규약 모으기
  /cci-linear-create-issue VRM 익스포트 파이프라인 점검 --priority 3 --label Pipeline
  /cci-linear-create-issue 텍스처 네이밍 컨벤션 위반 수정 --desc "Female 폴더 내 V01 누락 건" --due 2026-03-01
```
