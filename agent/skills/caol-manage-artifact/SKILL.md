...
| Operation | Skill / doc |
|-----------|-------------|
| Create skill | `agent/skills/caol-make-skill/SKILL.md` |
| Edit skill narrowly | `agent/skills/caol-edit-skill/SKILL.md` |
| Update skill broadly | `agent/skills/caol-update-skill/SKILL.md` |
| Delete skill | `agent/skills/caol-delete-skill/SKILL.md` |
| Audit skill | `agent/skills/caol-audit-skill/SKILL.md` |
| Create command | `agent/skills/caol-make-command/SKILL.md` |
| Create rule | `agent/skills/caol-make-rule/SKILL.md` |
| Create standard | `agent/skills/caol-make-standard/SKILL.md` |
| Inspect patterns | `agent/skills/caol-show-patterns/SKILL.md` |
| Browse commands | `agent/skills/caol-browse-commands/SKILL.md` |
| Browse standards | `agent/skills/caol-browse-standards/SKILL.md` |
...
| "small edit", "wording", "path fix", "frontmatter fix" | Patch the target artifact only. Use `caol-edit-skill` for skills. |
| "refresh", "modernize", "align policy", "validator drift", "refactor" | Do a broad update. Use `caol-update-skill` for skills. |
| "delete", "remove" | Search references first. Use `caol-delete-skill` for skills. |
...
- `agent/skills/caol-make-rule/SKILL.md`
