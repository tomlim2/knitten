...
Usage:
```
/ah-log-postmortem anju web/matcap-painter
/ah-log-postmortem <repo-root>
/ah-log-postmortem mega-melange
```
...
| Purpose | Path |
|---------|------|
| **Postmortem (always)** | `!`bash ~/.claude/skills/ah-resolve-doc-path/resolve.sh doc postmortem`/{project-name}.md` |
