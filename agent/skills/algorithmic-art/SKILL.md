...
description: p5.js algorithmic art with seeded randomness — generative art, flow fields, particle systems. Original work only.
...
The HTML artifact contains everything: p5.js (from CDN), the algorithm, parameter controls, and UI - all in one file that works immediately in an artifact host or any browser. Start from the template file, not from scratch.
...
To allow exploration of the generative art, create a single, self-contained HTML artifact. Ensure this artifact works immediately in an artifact host or any browser - no setup required. Embed everything inline.
...
1. **In an artifact host**: Displayed as an interactive artifact - runs instantly
