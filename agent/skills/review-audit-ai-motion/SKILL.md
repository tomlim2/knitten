...
```bash
!`bash ~/.claude/skills/ah-resolve-doc-path/resolve.sh tool blender` --background --python ~/.claude/skills/review-audit-ai-motion/analyze.py -- <source.fbx> [retargeted]
```
