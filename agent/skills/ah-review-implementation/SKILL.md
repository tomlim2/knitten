...
| Condition | Use |
|-----------|-----|
| one skill body needs depth audit | `ah-audit-skill` |
...
|-----------------|----------|
| `agent/skills/*/SKILL.md` | skill body, `ah-make-skill`, line count |
...
- `docs/plans/completed/ah-review-implementation.md`
