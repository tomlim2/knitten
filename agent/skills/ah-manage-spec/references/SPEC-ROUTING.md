...
| agent-hub policy, architecture, validator, path, skill/rule/standard work | agent-hub operational spec | `ah-manage-spec` |
...
| `ah-make-skill` | implementing or changing spec-management skills | skill structure and routing metadata |
| `ah-resolve-doc-path` | spec needs repo or vault paths | resolver-backed paths |
