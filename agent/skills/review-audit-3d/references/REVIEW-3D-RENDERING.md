...
This document defines **what to check** from a 3D rendering performance perspective. Use `agent/document-templates/review/code-review.md` for how to format findings.
