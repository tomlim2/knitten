...
| `video-hyperframes` | `video` | `agent-hub` | `hyperframes` | `implementation` | 25000 |
| `unreal-engine` | `unreal` | `anju`, `mega-melange` | - | `implementation`, `review` | 25000 |
| `web-frontend` | `web` | `agent-hub`, `mmd-anju`, `ta-portfolio` | `astro`, `three` | `implementation` | 25000 |
| `web-review` | `web` | `agent-hub`, `mmd-anju`, `ta-portfolio` | `astro`, `three` | `review` | 25000 |
| `obsidian-vault` | `obsidian` | `agent-hub` | - | `authoring`, `implementation`, `review` | 25000 |
