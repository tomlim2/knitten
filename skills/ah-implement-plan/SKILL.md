...
4. If editing a skill, apply the `activation-check` and Step 0 decisions from
   the spec. If missing and the change adds mutation behavior, pause and ask or
   infer from `docs/specs/skill-activation-check-policy.md`.
