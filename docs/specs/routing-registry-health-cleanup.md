...
Make Knitten's routing registries match the core plugin contract: generic KC
routing stays in Knitten, documented compatibility outputs stay explicit, and
...
- Cleaned and documented routing registry files.
