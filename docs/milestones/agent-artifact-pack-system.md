...
| [artifact-inventory-reviewed-decision-application.md](../plans/completed/artifact-inventory-reviewed-decision-application.md) | completed | Apply reviewed core-owned classification decisions to generated inventory output. |
...
| [installed-pack-durability-validation-policy.md](../plans/completed/installed-pack-durability-validation-policy.md) | completed | Define fsync-level writes and validation-failed journal policy. |
...
| Reviewed decision application | done | `docs/plans/completed/artifact-inventory-reviewed-decision-application.md`, `agent/config/artifact-inventory-reviewed-decisions.json`, and `agent/config/artifact-inventory.json` apply the first reviewed core-owned classification report to generated inventory. |
...
| done | `artifact-inventory-reviewed-decision-application` | Reviewed core-owned decisions are encoded and validator-protected. |
