...
| [artifact-pack-validation-gates.md](../plans/proposed/artifact-pack-validation-gates.md) | proposed | Define validator checks for manifest integrity and route conflicts. |
...
| Validation gates | proposed | `docs/plans/proposed/artifact-pack-validation-gates.md` defines gate behavior, fixture strategy, and core capability registry defaults. |
