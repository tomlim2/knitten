...
| Pack boundary | Optional skills, standards, templates, and working documents live in plugin or artifact-pack repositories. |
| Core boundary | This repo keeps the minimal policy, registry, and resolver skeleton needed before optional domain plugins load. |
