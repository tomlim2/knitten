...
| Sibling plan | `caol-ila/docs/plans/stage-define-map-document-bundle-layout.md` | Agrees: STL-422 should implement against the STL-421 contract and must not guess fields before the contract lands. |
