...
| Plan sibling Phase 2a | Already Done | `caol-ila/docs/plans/gltf-add-axis-primary-child-picker.md` locks private module, no byte mutation, no cache bump, synthetic JSON tests. |
| Plan sibling Phase 2b | Already Done | `caol-ila/docs/plans/gltf-add-axis-correction-calculator.md` locks right-multiply local correction, invalid-input `None`, no rest-pose mutation. |
