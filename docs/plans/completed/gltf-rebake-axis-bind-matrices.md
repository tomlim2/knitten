...
| Sibling Phase 2c plan | Consumed | `agent-hub/docs/plans/completed/gltf-apply-vrm-axis-bake-rest-pose.md` explicitly excludes mesh, skin, inverseBindMatrix, accessor, bufferView, and BIN mutation. |
