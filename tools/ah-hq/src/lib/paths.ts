...
export const AGENT_HUB_CONFIG_DIR = join(PRIVATE_DIR, 'agent-hub-config');

export const REPO_PATHS_FILE = join(AGENT_HUB_CONFIG_DIR, 'repo-paths.json');
export const MACHINE_PATHS_FILE = join(AGENT_HUB_CONFIG_DIR, 'machine-paths.json');
export const VAULT_STRUCTURE_FILE = join(AGENT_HUB_CONFIG_DIR, 'vault-structure.json');
export const HARDWARE_FILE = join(AGENT_HUB_CONFIG_DIR, 'hardware.json');
...
export function vaultProjectDir(projectKey: string): string | null {
