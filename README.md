...
| `triggered` | 15 | `author.md`, `cinev-git.md`, `code-write.md`, `doc-write.md`, `main-chore-lane.md`, `metaphor-style.md`, `obsidian.md`, `pr-comment.md`, `pr-create.md`, `pr-mutate.md`, `reread-repo-conventions.md`, `slack.md`, `task-context-routing.md`, `test-write.md`, `writing-external.md` |
| `index` | 1 | `index.md` |
<!-- /generated:readme-inventory -->
